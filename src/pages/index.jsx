...
function App() {
  ...
  return (
    ...
    <img id = "logoImg"src = {logoImg}></img>
      ...
      <AboutUs headText ="WHO WE ARE" slogan = "We're Our Blooms® and we're here to help you find your floral story."/>

      <SwiperShowcase/>

      <Title title = "WHAT WE DO" description = "We bring a touch of that simple magic into your world."/>

      <Services/>

      <BigImage path = {bigImage1}/>

      <AboutUs headText ="WORK WITH US" slogan = "Discover how we can add a touch of natural beauty to your next event."/>
    </>
  )
}
